...
def create_cell(path=None, max_segment_length=24.3):
    import neuron
    ...
    cell = h.PassiveDendsSimpleSomaModel(morph_dir, morph_name, max_segment_length)
    ...
    # from me
    rho_test = 32.58690275984611
    rho_axon_test = 247.23080159409773
